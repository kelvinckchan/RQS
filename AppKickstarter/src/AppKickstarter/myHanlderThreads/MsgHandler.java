...
public class MsgHandler extends AppThread {
	...
	/**
	 * Separate different types of messages (TicketReq, TicketAck, CheckOut, TicketCall, TimesUp, Terminate)
	 * 
	 */
	 ...
	 * @param msg : The message of ticket request 
	 */
	 ...
	 * @param msg : The message of ticket acknowledgement 
	 */
