...
public class Timer extends AppThread {
	...
	ticks = new Integer(appKickstarter.getProperty("TimerNTicksPerSec"));
	simulationSpeed = new Integer(appKickstarter.getProperty("TimerSimulationSpeed"));
    } // Timer
	...
	return Integer.parseInt(msg.getDetails().substring(1).substring(0, 5));
